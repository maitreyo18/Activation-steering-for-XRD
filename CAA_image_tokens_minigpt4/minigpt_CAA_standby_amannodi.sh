...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./extract_image_tokens_CAA_batch.py --csv_path ./train.csv --save_path ./diff_act_bgm_ring_6-24.pt --cfg_path ../eval_configs/minigpt4_eval.yaml