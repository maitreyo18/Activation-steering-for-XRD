...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./extract_image_tokens_CAA_batch_12-24.py --csv_path ./train.csv --save_path ./diff_act_bgm_ring_12-24_2.pt --cfg_path ../eval_configs/minigpt4_eval.yaml