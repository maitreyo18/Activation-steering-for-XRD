...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python extract_img_tokens.py --layers 4 8 10 --img_dir "./train_classify" --csv_path "./train_classify/train_classify.csv" --save_path "./activation_train_4-10_MLP.pt"