...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python extract_img_tokens.py --layers 4 8 10 --img_dir "./test_classify" --csv_path "./test_classify/test_classify.csv" --save_path "./activation_test_4-10_MLP.pt"
