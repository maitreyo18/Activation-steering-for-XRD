...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./CAA_simplified_full_2.py --csv_path ./train_generate_loop_scattering.csv --save_path ./act_diff_12-20_loop_scatter_100_bg_ring.pt --cfg_path ../eval_configs/minigpt4_eval.yaml