...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./CAA_generate_all_anomalies.py --csv_path ./train_generate_loop_scattering.csv --image_dir "../datasets/XRD_data/one_correct/loop_scattering" --correct_anomaly "Loop scattering" --cfg_path ../eval_configs/minigpt4_eval.yaml