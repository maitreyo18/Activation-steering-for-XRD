...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./CAA_generate_all_anomalies.py --csv_path ./train_generate_strong_bg.csv --image_dir "../datasets/XRD_data/one_correct/strong_background" --correct_anomaly "Strong background" --wrong_anomalies "Loop scattering" "Artifact" "Ice ring" "Non-uniform detector" "No distinct anomalies" "Background ring" "Diffuse scattering" --cfg_path ../eval_configs/minigpt4_eval.yaml