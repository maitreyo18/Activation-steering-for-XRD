...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./CAA_simplified.py --csv_path ./train.csv --temperature 0.5 --save_path ./diff_act_bgm_ring_12-16-20.pt --cfg_path ../eval_configs/minigpt4_eval.yaml