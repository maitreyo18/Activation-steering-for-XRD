...
#SBATCH -t 02:00:00
#SBATCH --job-name Composite-Steering
...
# Run the composite steering script
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./test_steering_composite.py \
    --test_csv "./test_combined.csv" \
