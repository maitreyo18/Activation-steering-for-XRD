...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./CAA_generate_all_anomalies_qwen.py --csv_path ./train_generate.csv --image_dir "../datasets/XRD_data/one_correct/background_ring" --correct_anomaly "Background ring" --wrong_anomalies "Loop scattering" "Diffuse scattering" "Ice ring" "Artifact" "No distinct anomalies" "Non-uniform detector" "Strong background"