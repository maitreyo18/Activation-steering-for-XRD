...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./CAA_generate_all_anomalies_qwen.py --csv_path ./train_generate_nu_detect.csv --image_dir "../datasets/XRD_data/one_correct/non_uniform_detector" --correct_anomaly "Non-uniform detector" --wrong_anomalies "Loop scattering" "Diffuse scattering" "Ice ring" "Artifact" "No distinct anomalies" "Background ring" "Strong background"