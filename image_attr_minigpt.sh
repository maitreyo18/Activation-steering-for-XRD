...
# First run the attribution extraction
CUDA_VISIBLE_DEVICES=0 python ./extract_attr/extract_minigpt_desc_attr.py

# Then run the activation extraction
CUDA_VISIBLE_DEVICES=0 python ./extract_act/extracting_activations_minigpt_desc.py