...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./CAA_modified_generate.py --test_csv "./test.csv" --image_dir "../datasets/XRD_data/one_correct/background_ring" --alpha 3.0 --steer_layer 16 --steering_vectors_path "../CAA_modified/diff_act_bgm_ring_12-16-20_600.pt"