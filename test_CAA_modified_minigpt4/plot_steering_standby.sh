...
# Create the Activations_visualize directory
mkdir -p ./Activations_visualize

# Run the activation extraction script
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./extract_activations_avg_final.py \
    --csv_path "./test_combined.csv" \
    --save_dir "./Activations_visualize" \
