...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./CAA_modified_generate.py --test_csv "./test_generate_ice_ring.csv" --image_dir "../datasets/XRD_data/one_correct/ice_ring" --alpha 0.78 --steer_layer 12 --steering_vectors_path "../CAA_modified/Ice_ring/act_diff_12-20_ice_ring_76_art.pt"