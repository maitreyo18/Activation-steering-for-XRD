...
#SBATCH -t 05:00:00
#SBATCH --job-name Qwen2VL-Neutral
...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./model_neutral.py --test_csv ./test_generate_nu_detect.csv --image_dir ../datasets/XRD_data/one_correct/non_uniform_detector 