...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./CAA_modified_generate_qwen.py --test_csv "./test_generate_nu_detect.csv" --image_dir "../datasets/XRD_data/one_correct/non_uniform_detector" --alpha 0.9 --steer_layer 14 --steering_vectors_path "../CAA_modified_qwen/nu_detector_act_diff_10-20_129_no_distinct_anomalies.pt" 