...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./calibration_act_layer_6-24.py --csv_path ./reference_input.csv --save_path ./calibration_act_6-24.pt --cfg_path ../eval_configs/minigpt4_eval.yaml