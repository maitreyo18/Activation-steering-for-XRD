...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python generate_reference_activations.py --csv_path ./reference_input.csv --save_path ./reference_activation_XRD.pt --cfg_path ../eval_configs/minigpt4_eval.yaml