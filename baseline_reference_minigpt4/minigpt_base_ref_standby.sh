...
PYTHONPATH=.. CUDA_VISIBLE_DEVICES=0 python ./calibration_activation.py --csv_path ./reference_input.csv --save_path ./calibration_activation.pt --cfg_path ../eval_configs/minigpt4_eval.yaml